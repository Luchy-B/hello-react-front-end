...
> Hello React FrontEnd is an application for fetcing the api for the backend of the rails server.
...
[React-Rails-Backend](https://github.com/Luchy-B/hello_rails_back_end)
...
Clone this [repository](https://github.com/Luchy-B/hello-react-front-end.git) to your desired folder:

```sh
  git https://github.com/Luchy-B/hello-react-front-end.git
...
Feel free to check the [issues page](https://github.com/Luchy-B/hello-react-front-end.git).
